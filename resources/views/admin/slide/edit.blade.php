    ...
    @component('admin.component.tab')
        ...
        @slot('body')
            <div class="tab-pane fade active show" id="custom-tabs-create" role="tabpanel" aria-labelledby="custom-tabs-create-tab">
                @component('admin.component.form', ['url' => "/admin/slide/{$slide['id']}", 'method' => 'put'])
                    @slot('form_body')
                        <input type="hidden" name="content">
                        <div class="form-group row">
                            <label for="" class="col-sm-1 col-form-label">名称</label>
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="" name="name" value="{{$slide['name']}}">
                            </div>
                        ...
                        <div class="col-sm-6 row mb-3">
                            ...
                            <div class="col-sm ml-2" id="img-show">
                                <img src="{{asset($slide['content'])}}" class="rounded" alt="" style="max-height: 150px;max-width: 450px">
                            </div>
                        </div>
                        <div class="form-group row">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <select class="custom-select" name="status">
                                    <option value="1" {{$slide['status']==1?'selected':''}}>显示</option>
                                    <option value="0" {{$slide['status']==0?'selected':''}}>隐藏</option>
                                </select>
                            </div>
                        </div>
                        <div class="form-group row">
                            ...
                            <div class="col-sm-5">
                                <input type="text" class="form-control" id="" placeholder="" name="sort" value="{{$slide['sort']}}">
                            </div>
                        </div>
                    @endslot
                    @slot('form_footer')

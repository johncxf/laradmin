...
@section('content')
    <div class="card card-info col-12">
        <!-- form start -->
        <form action="{{route('menu.update', $menu->id)}}" method="post" class="form-horizontal" style="margin-left: 100px">
            @csrf
            {{--伪造表单--}}
            @method('PUT')
            <div class="card-body">
        ...
        <!-- /.card-body -->
            <div class="card-footer">
                ...
                <a href="{{route('menu.index')}}" class="btn btn-outline-secondary">返回</a>
            </div>
            <!-- /.card-footer -->
        </form>
    </div>

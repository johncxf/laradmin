...
(function ($) {
  ...
  var $no_border_container = $('<div />', {'class': 'mb-1'}).append($no_border_checkbox).append('<span>取消顶部导航体</span>')
  ...
  var $text_sm_header_container = $('<div />', {'class': 'mb-1'}).append($text_sm_header_checkbox).append('<span>顶部导航缩小</span>')
